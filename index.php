...
<html lang="en">
  ...
  <body>
    <main>
      ...
      <section class="container g-pt-80 g-pb-40">
        <div class="row">
          <div class="col-lg-6 g-mb-30 text-center order-md-2">
            <img class="img-fluid" src="assets/img/nuunaa_product-03.png" alt="Image Description">
          </div>
          <div class="col-lg-6 g-mb-60 g-pt-60 order-md-1">
            <div class="mb-0">
              <p class="lead mb-0" style="font-weight: 400;">Nuuna Alpha Gluta</p>
            </div>
            <div class="mb-4">
              <h2 class="h1 text-uppercase mb-3 color-primary font-family-athiti">วิตามินสลายฝ้า กระ ริ้วรอย <br/>จุดด่างดำ ผิวหมองคล้ำ</h2>
              <div class="g-width-60 g-height-1 g-bg-black"></div>
            </div>
            <div class="mb-4">
              <p class="content-indent">
                เป็นวิตามินที่มาจากธรรมชาติ ซึ่งไม่ใช่การรักษาฝ้า แต่เป็นการฟื้นฟูสภาพผิวจากภายในให้กลับมาสุขภาพดีขึ้น 
                และช่วยลดเลือนริ้วรอยฝ้า กระ จุดด่างดำ จึงทำให้เป็นไปอย่างช้าๆและอาจจะใช้เวลานานขึ้นอยู่ที่ตัวบุคคลว่ามีฝ้าผังลึกมากแค่ไหน…
              </p>
            </div>
            <a class="btn btn-xl btn-primary g-font-size-default" href="#!">สั่งซื้อ / สอบถาม</a>
          </div>
        </div>
      </section>
      <!-- End Section -->
        ...
        <div class="container g-pt-60 g-pb-40">
          <div class="row justify-content-center g-mb-50">
            <div class="col-lg-7">
              ...
              <div class="text-center">
                ...
                <p class="lead mb-0">มีความปลอดภัยเพราะเป็นการฟื้นฟูจากภายใน ไร้สารตกค้างและผลข้างเคียง ด้วยสารสกัดจากธรรมชาติที่เข้มข้น และวิจัยมาเพื่อฝ้าโดยเฉพาะ</p>
              </div>
              <!-- End Heading -->
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-3 g-mb-10">
              ...
              <div class="text-center">
                <span class="color-primary g-font-size-26">
                  <img class="img-fluid" style="width: 100px; margin-bottom: 20px;" src="assets/img/nunaa-pix-01.png">
                </span>
              </div>
              <div class="media g-mb-15">
                <div class="media-body">
                  <h3 class="h5 g-color-black mb-20 text-center">ลดฝ้า กระ</h3>
            ...
            <div class="col-lg-3 g-mb-10">
              ...
              <div class="text-center">
                <span class="color-primary g-font-size-26">
                  <img class="img-fluid" style="width: 100px; margin-bottom: 20px;" src="assets/img/nunaa-pix-02.png">
                </span>
              </div>
              <div class="media g-mb-15">
                <div class="media-body">
                  <h3 class="h5 g-color-black mb-20 text-center">ปกป้อง</h3>
            ...
            <div class="col-lg-3 g-mb-10">
              ...
              <div class="text-center">
                <span class="color-primary g-font-size-26">
                  <img class="img-fluid" style="width: 100px; margin-bottom: 20px;" src="assets/img/nunaa-pix-03.png">
                </span>
              </div>
              <div class="media g-mb-15">
                <div class="media-body">
                  <h3 class="h5 g-color-black mb-20 text-center">ปลอดภัย</h3>
            ...
            <div class="col-lg-3 g-mb-10">
              ...
              <div class="text-center">
                <span class="color-primary g-font-size-26">
                  <img class="img-fluid" style="width: 100px; margin-bottom: 20px;" src="assets/img/nunaa-pix-04.png">
                </span>
              </div>
              <div class="media g-mb-15">
                <div class="media-body">
                  <h3 class="h5 g-color-black mb-20 text-center">เพิ่มความมั่นใจ</h3>
            ...
            <div class="col-lg-12">
              <div class="g-pa-10 g-pt-10 text-center">
                <p>
                  ...
                  <strong class="g-color-black">1 กล่อง บรรจุ 10 เม็ด แคปซูล</strong><br/>
      ...
      <section id="review" class="g-pt-30 g-py-40 g-bg-secondary" 
        style="background-image: url(assets/img/bg/bg-review-02.png);
          ...
          <div class="row justify-content-center">
            <div class="col-md-6">
              ...
              <div class="text-center g-mb-20">
                <h2 class="h3 text-uppercase mb-2 color-primary font-family-athiti">รีวิวจากผู้ใช้</h2>
                <div class="d-inline-block g-width-60 g-height-1 g-bg-black mb-2"></div>
                <p class="lead mb-0">การตอบรับจากผู้ใช้จริงและกลับมาซื้อซ้ำ จึงสามารถมั่นใจในตัววิตามินสลายฝ้า ว่าเป็นผลิตภัณฑ์สกัดจากธรรมชาติ และวิจัยมาเพื่อฝ้าโดยเฉพาะ</p>
              </div>
              <!-- End Heading -->
              <div class="container">
      ...
      <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall " data-options='{direction: "fromtop", animation_duration: 25, direction: "reverse"}'>
        <!-- Parallax Image -->
        <div class="dzsparallaxer--target w-100 u-bg-overlay g-bg-img-hero g-bg-white-opacity-0_0--after" style="height: 140%; background-image: url(assets/img/bg/nuuna_pix-line_content-02.jpg);"></div>
        <!-- End Parallax Image -->
        ...
        <div class="row no-gutters u-shadow-v21 g-mt-minus-150">
          <div class="col-md-4">
            ...
            <div class="g-brd-around--md g-brd-gray-light-v4 g-bg-white text-center g-pa-10 g-px-10--lg g-py-10--lg min-height-1_5">
              ...
              <a href="tel:0825878661"><p class="g-color-gray-dark-v4">082-587-8661</p></a>
          ...
          <div class="col-md-4">
            ...
            <div class="g-brd-around--md g-brd-gray-light-v4 g-bg-white text-center g-pa-10 g-px-10--lg g-py-10--lg min-height-1_5">
              ...
              <a href="https://line.me/ti/p/@nuuna" target="_blank"><p class="g-color-gray-dark-v4">LINE @</p></a>
              <div class="d-inline-block g-width-40 g-brd-bottom g-brd-gray-dark-v5 g-my-15"></div>
            </div>
            <!-- End Icon Blocks -->
          </div>
          ...
          <div class="col-md-4">
            ...
            <div class="g-brd-around--md g-brd-gray-light-v4 g-bg-white text-center g-pa-10 g-px-10--lg g-py-10--lg min-height-1_5">
              ...
              <a href="https://www.facebook.com/thailandnuuna/" target="_blank"><p class="g-color-gray-dark-v4">นูน่า วิตามินสลายฝ้า กระ Nuuna Thailand</p></a>
              <div class="d-inline-block g-width-40 g-brd-bottom g-brd-gray-dark-v5 g-my-15"></div>
            </div>
            <!-- End Icon Blocks -->
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-8 g-mb-40">
            ...
            <form>
              ...
              <div class="text-center">
                <button class="btn btn-primary btn-md text-uppercase g-font-weight-700 g-font-size-12 g-rounded-3 g-px-40 g-py-15 mb-0" type="submit" role="button">ส่งข้อมูล</button>
              </div>
            </form>
          </div>
        </div>
